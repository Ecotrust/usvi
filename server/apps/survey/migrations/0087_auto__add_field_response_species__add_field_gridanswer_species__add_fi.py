...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.species'
        db.add_column(u'survey_response', 'species',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Species'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'GridAnswer.species'
        db.add_column(u'survey_gridanswer', 'species',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Species'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MultiAnswer.species'
        db.add_column(u'survey_multianswer', 'species',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Species'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Response.species'
        db.delete_column(u'survey_response', 'species_id')

        # Deleting field 'GridAnswer.species'
        db.delete_column(u'survey_gridanswer', 'species_id')

        # Deleting field 'MultiAnswer.species'
        db.delete_column(u'survey_multianswer', 'species_id')
    ...
    models = {
        ...
        u'survey.gridanswer': {
            ...
            'species': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Species']", 'null': 'True', 'blank': 'True'})
        },
        u'survey.location': {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c92bbb4d-82fb-4aea-9843-3d9c7394a5c1'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
