...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respondant.entered_by'
        db.add_column(u'survey_respondant', 'entered_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='entered_by', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respondant.entered_by'
        db.delete_column(u'survey_respondant', 'entered_by_id')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'23f032b2-d527-48ee-955b-085b9a765db1'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
