...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MultiAnswer.area'
        db.add_column(u'survey_multianswer', 'area',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Area'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MultiAnswer.area'
        db.delete_column(u'survey_multianswer', 'area_id')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'098cf341-198c-40e2-8ad9-2c78f2d27c2e'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
