...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respondant.agency_id'
        db.add_column(u'survey_respondant', 'agency_id',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respondant.agency_id'
        db.delete_column(u'survey_respondant', 'agency_id')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'28a19bf3-a90e-4169-9ea9-00ba3038956c'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
