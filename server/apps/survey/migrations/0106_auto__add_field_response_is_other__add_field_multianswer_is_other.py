...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Response.is_other'
        db.add_column(u'survey_response', 'is_other',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MultiAnswer.is_other'
        db.add_column(u'survey_multianswer', 'is_other',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Response.is_other'
        db.delete_column(u'survey_response', 'is_other')

        # Deleting field 'MultiAnswer.is_other'
        db.delete_column(u'survey_multianswer', 'is_other')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'04a5d82a-eb92-4426-b39e-543a5ef883be'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
