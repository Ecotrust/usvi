...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_respondant', 'review_status',
                      self.gf('django.db.models.fields.CharField')(default=u'needs review', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respondant.review_status'
        db.delete_column(u'survey_respondant', 'review_status')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'34eda11d-4f76-4dfe-9182-96583d0ffb85'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
