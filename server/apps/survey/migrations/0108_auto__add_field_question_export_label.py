...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_question', 'export_label',
                      self.gf('django.db.models.fields.CharField')(default='heading_not_set', max_length=254),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.export_label'
        db.delete_column(u'survey_question', 'export_label')
