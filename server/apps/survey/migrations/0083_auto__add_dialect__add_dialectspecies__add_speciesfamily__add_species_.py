...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Question.dialect'
        db.add_column(u'survey_question', 'dialect',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Dialect'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Question.dialect'
        db.delete_column(u'survey_question', 'dialect_id')
    ...
    models = {
        ...
        u'survey.dialectspecies': {
            'Meta': {'object_name': 'DialectSpecies'},
            'dialect': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Dialect']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '144'}),
            'species': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Species']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'survey.gridanswer': {
        ...
        u'survey.question': {
            ...
            'dialect': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Dialect']", 'null': 'True', 'blank': 'True'}),
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'67fe8a8f-9b2d-43f3-8209-009ada72f22f'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
        ...
        u'survey.species': {
            ...
            'family': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.SpeciesFamily']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '144'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'survey.speciesfamily': {
