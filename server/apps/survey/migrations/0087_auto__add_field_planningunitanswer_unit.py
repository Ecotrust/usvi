...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanningUnitAnswer.unit'
        db.add_column(u'survey_planningunitanswer', 'unit',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanningUnitAnswer.unit'
        db.delete_column(u'survey_planningunitanswer', 'unit')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 21, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a8e76ed9-3aba-4c65-95b9-b0b3f3053ff6'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
