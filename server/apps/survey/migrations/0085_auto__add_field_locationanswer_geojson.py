...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationAnswer.geojson'
        db.add_column(u'survey_locationanswer', 'geojson',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationAnswer.geojson'
        db.delete_column(u'survey_locationanswer', 'geojson')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 21, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a0e336a5-b34b-4f20-8d6e-2cdbd8711d20'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
