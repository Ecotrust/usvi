...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Respondant.state'
        db.delete_column(u'survey_respondant', 'state')

        # Deleting field 'Respondant.locations'
        db.delete_column(u'survey_respondant', 'locations')

        # Deleting field 'Respondant.county'
        db.delete_column(u'survey_respondant', 'county')

        # Adding field 'Respondant.island'
        db.add_column(u'survey_respondant', 'island',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Respondant.state'
        db.add_column(u'survey_respondant', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Respondant.locations'
        db.add_column(u'survey_respondant', 'locations',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Respondant.county'
        db.add_column(u'survey_respondant', 'county',
                      self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Respondant.island'
        db.delete_column(u'survey_respondant', 'island')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0cf32a52-d314-43f4-83dc-38900d962748'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
