...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Respondant.ordering_date'
        db.alter_column(u'survey_respondant', 'ordering_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # Changing field 'Respondant.ordering_date'
        db.alter_column(u'survey_respondant', 'ordering_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'384a60db-4afc-4e56-a32e-727f27b73b1b'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
