...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for r in orm['survey.Respondant'].objects.all():
            for question in r.response_set.values('question__slug', 'question__type').distinct():
                responses = r.response_set.filter(question__slug=question['question__slug']).order_by('ts')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f21d63b3-af2c-40b1-bf08-c18af38616fc'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
