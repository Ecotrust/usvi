...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'survey_dialectspecies')

        # Deleting model 'SpeciesFamily'
        db.delete_table(u'survey_speciesfamily')

        # Deleting model 'Species'
        db.delete_table(u'survey_species')


        # Changing field 'Response.species'
        db.alter_column(u'survey_response', 'species_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acl.Species'], null=True))

        # Changing field 'GridAnswer.species'
        db.alter_column(u'survey_gridanswer', 'species_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acl.Species'], null=True))

        # Changing field 'MultiAnswer.species'
        db.alter_column(u'survey_multianswer', 'species_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acl.Species'], null=True))

    def backwards(self, orm):
        # Adding model 'Dialect'
        db.create_table(u'survey_dialect', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=48, unique=True)),
        ...
        db.send_create_signal(u'survey', ['Dialect'])

        # Adding model 'DialectSpecies'
        db.create_table(u'survey_dialectspecies', (
            ('dialect', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Dialect'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=144)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('species', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Species'])),
        ))
        db.send_create_signal(u'survey', ['DialectSpecies'])

        # Adding model 'SpeciesFamily'
        db.create_table(u'survey_speciesfamily', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=48, unique=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'survey', ['SpeciesFamily'])

        # Adding model 'Species'
        db.create_table(u'survey_species', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=48, unique=True)),
            ('erdmans_code', self.gf('django.db.models.fields.CharField')(max_length=48)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('family', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.SpeciesFamily'])),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=144)),
        ))
        db.send_create_signal(u'survey', ['Species'])


        # Changing field 'Response.species'
        db.alter_column(u'survey_response', 'species_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Species'], null=True))

        # Changing field 'GridAnswer.species'
        db.alter_column(u'survey_gridanswer', 'species_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Species'], null=True))

        # Changing field 'MultiAnswer.species'
        db.alter_column(u'survey_multianswer', 'species_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Species'], null=True))
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ae0fdfa2-b4f7-446d-ac61-3f37b778f592'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
