...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respondant.notify'
        db.add_column(u'survey_respondant', 'notify',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respondant.notify'
        db.delete_column(u'survey_respondant', 'notify')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ec0b3283-1eae-47f7-80d5-e6c9bd1adb9c'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
