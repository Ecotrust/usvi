...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Respondant.comment'
        db.add_column(u'survey_respondant', 'comment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Respondant.comment'
        db.delete_column(u'survey_respondant', 'comment')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8a96ebe3-e58b-457e-971c-c75fa7550125'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
