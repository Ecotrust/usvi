...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Response.answer_date'
        db.add_column(u'survey_response', 'answer_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Respondant.csv_row'
        db.add_column(u'survey_respondant', 'csv_row',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.CSVRow'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Response.answer_date'
        db.delete_column(u'survey_response', 'answer_date')

        # Deleting field 'Respondant.csv_row'
        db.delete_column(u'survey_respondant', 'csv_row_id')
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 24, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a95cf271-5772-4536-aeac-d63ceef380ff'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
