...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlanningUnitAnswer'
        db.create_table(u'survey_planningunitanswer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('answer', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('response', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Response'])),
            ('respondant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Respondant'], null=True, blank=True)),
            ('related_question_slug', self.gf('django.db.models.fields.SlugField')(max_length=64)),
        ))
        db.send_create_signal(u'survey', ['PlanningUnitAnswer'])


    def backwards(self, orm):
        # Deleting model 'PlanningUnitAnswer'
        db.delete_table(u'survey_planningunitanswer')
    ...
    models = {
        ...
        u'survey.planningunitanswer': {
            'Meta': {'object_name': 'PlanningUnitAnswer'},
            'answer': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'related_question_slug': ('django.db.models.fields.SlugField', [], {'max_length': '64'}),
            'respondant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Respondant']", 'null': 'True', 'blank': 'True'}),
            'response': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Response']"})
        },
        u'survey.question': {
        ...
        u'survey.respondant': {
            ...
            'ts': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 6, 0, 0)'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'563d793a-0eb8-4c28-8c97-6ad70ddf4495'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
