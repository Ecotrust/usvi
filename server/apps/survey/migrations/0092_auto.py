...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'survey_respondant_responses'))


    def backwards(self, orm):
        # Adding M2M table for field responses on 'Respondant'
        m2m_table_name = db.shorten_name(u'survey_respondant_responses')
        ...
        db.create_unique(m2m_table_name, ['respondant_id', 'response_id'])
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a390b13b-83b9-4a60-a5b9-6a88462d46b8'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
