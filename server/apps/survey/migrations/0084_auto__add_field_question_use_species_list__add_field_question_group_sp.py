...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.use_species_list'
        db.add_column(u'survey_question', 'use_species_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Question.group_species_list'
        db.add_column(u'survey_question', 'group_species_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.use_species_list'
        db.delete_column(u'survey_question', 'use_species_list')

        # Deleting field 'Question.group_species_list'
        db.delete_column(u'survey_question', 'group_species_list')
    ...
    models = {
        ...
        u'survey.question': {
            ...
            'group_species_list': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5cc11579-5035-4cbf-a5b6-cda751f23674'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
