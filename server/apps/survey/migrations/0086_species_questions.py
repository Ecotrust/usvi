...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        species_slugs = ['spear-or-by-hand-species-st-croix',
                         'trap-species-st-thomas-st-john',
                         'net-species-st-thomas-st-john',
                         'spear-or-by-hand-species-st-thomas-st-john',
                         'trap-species-st-croix',
                         'net-species-st-croix',
                         'line-or-reel-species-st-croix',
                         'line-or-reel-species-st-thomas-st-john']
        for q in orm['survey.Question'].objects.filter(slug__in=species_slugs):
            q.use_species_list = True
            q.save()
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b07ada5f-ded5-4ad8-80a3-8fb5534f4a76'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
