...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for obj in orm.PlanningUnitAnswer.objects.all():
            ans = json.loads(obj.answer)
            obj.unit = int(ans['id'])
            print "Adding unit id %s to pua %s" %(obj.unit, obj.id)
            obj.save()
    ...
    models = {
        ...
        u'survey.respondant': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f922c464-d75b-4683-8b86-094d0829e54c'", 'max_length': '36', 'primary_key': 'True'})
        },
        u'survey.response': {
