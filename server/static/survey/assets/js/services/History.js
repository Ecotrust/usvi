...
angular.module('askApp')
    .factory('history', function($http, $location) {
        ...
        var getTitle = function(respondent) {
            return _.findWhere(app.surveys, {
                slug: respondent.survey
            }).name;
        };

        var gearTypeIncludes = function(type, respondent) {
            try {
                var gearTypes = _.pluck(_.findWhere(respondent.responses, {
                    question: 'gear-type'
                }).answer, 'label');
        ...
        var getAnswer = function(questionSlug, respondent) {
            ...
            try {
                if (questionSlug === 'weight-line-or-reel' || questionSlug === 'weight-traps' || questionSlug === 'weight-nets' || questionSlug === 'weight-spear-or-by-hand') {
                    var island = _.findWhere(respondent.responses, {
                        question: 'island'
                    }).answer.label,
                        islandSlug = (island === 'st-thomas' || island === 'st-john') ? 'st-thomas-st-john' : island,
                        answer = _.findWhere(respondent.responses, {
                            question: questionSlug + '-' + islandSlug
                        }).answer;
                    ...
                    var answer = _.findWhere(respondent.responses, {
                        question: questionSlug
                    }).answer;
                } else if (questionSlug === 'days-soaked-lobster-traps') {
                    var unit = _.findWhere(respondent.responses, {
                        question: 'time-soaked-lobster-traps'
                    }).answer.unit,
                        value = _.findWhere(respondent.responses, {
                            question: 'time-soaked-lobster-traps'
                        }).answer.value;
                    ...
                    var unit = _.findWhere(respondent.responses, {
                        question: 'time-soaked-fish-traps'
                    }).answer.unit,
                        value = _.findWhere(respondent.responses, {
                            question: 'time-soaked-fish-traps'
                        }).answer.value;
                    ...
                    var island = _.findWhere(respondent.responses, {
                        ...
                        areas = _.findWhere(respondent.responses, {
                            question: 'areas-fished-line-or-reel-' + island
                        }).answer;
                    ...
                    var island = _.findWhere(respondent.responses, {
                        ...
                        areas = _.findWhere(respondent.responses, {
                            question: 'areas-fished-traps-' + island
                        }).answer;
                    var answer = areas.toString();
                    ...
                    var island = _.findWhere(respondent.responses, {
                        ...
                        areas = _.findWhere(respondent.responses, {
                            question: 'areas-fished-nets-' + island
                        }).answer;
                    var answer = areas.toString();
                    ...
                    var island = _.findWhere(respondent.responses, {
                        ...
                        areas = _.findWhere(respondent.responses, {
                            question: 'areas-fished-spear-or-by-hand-' + island
                        }).answer;
                    var answer = areas.toString();
